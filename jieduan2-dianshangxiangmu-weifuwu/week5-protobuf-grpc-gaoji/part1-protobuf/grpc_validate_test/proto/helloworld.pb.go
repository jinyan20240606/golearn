...
type HelloRequest struct {
	...
	// 验证器：在定义类型时直接添加验证规则
	// protoc-gen-validate 插件会���动生成 Validate() 方法
...
const file_helloworld_proto_rawDesc = "" +
	"\n" +
	"\x10helloworld.proto\x1a\x17validate/validate.proto\"K\n" +
	"\fHelloRequest\x12\x1d\n" +
	"\x04name\x18\x01 \x01(\tB\t\xfaB\x06r\x04\x10\x02\x18\n" +
	"R\x04name\x12\x1c\n" +
	"\x03age\x18\x02 \x01(\x05B\n" +
	"\xfaB\a\x1a\x05\x18\x96\x01 \x00R\x03age\"&\n" +
	"\n" +
	"HelloReply\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage23\n" +
	"\aGreeter\x12(\n" +
	"\bSayHello\x12\r.HelloRequest\x1a\v.HelloReply\"\x00B\n" +
